...
import kotlinx.android.synthetic.main.fragment_forgot_password.view.btn_back
import kotlinx.android.synthetic.main.fragment_forgot_password.view.et_email
    ...
    override fun onCreateView(
        ...
        mView.btn_get_code.setOnClickListener {
            ...
            else
            {
                ...
                replaceFragment(VerificationFragment(),VerificationFragment.javaClass.simpleName,true,true)
            }
