 ...
 * Use the [InviteUsersFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class InviteUsersFragment : BaseFragment() {
    ...
    private fun initUsersRecyclerview()
    {
        ...
        mView.rv_invite_friend.adapter = context?.let { InviteFriendsAdapter(it,friendList) }
