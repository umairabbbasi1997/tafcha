 ...
 * Use the [ChallengeFriendsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ChallengeFriendsFragment() : BaseFragment() {
    ...
    private fun initTrainingRecyclerview()
    {
        ...
        mView.rv_challlenge_friends.adapter = context?.let { ChallengeFriendsAdapter(it,friendList) }
    ...
    companion object {
         ...
         * @return A new instance of fragment ChallengeFriendsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChallengeFriendsFragment().apply {
