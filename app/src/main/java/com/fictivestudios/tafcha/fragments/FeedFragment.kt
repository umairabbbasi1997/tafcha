...
class FeedFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        initChallengeFeedRecyclerview()
        return mView
    }

    private fun initChallengeFeedRecyclerview()
    {
        ...
        mView.rv_chalanege_feed.adapter = context?.let { ChallengesFeedAdapter(it,challengeFeedList) }
