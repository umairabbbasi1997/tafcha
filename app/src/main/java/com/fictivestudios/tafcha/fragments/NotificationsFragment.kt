...
class NotificationsFragment : BaseFragment() {
    ...
    private fun initTrainingRecyclerview()
    {
        ...
        notificationList.add("Justin Wade")
        notificationList.add("Justin Wade")
        notificationList.add("Justin Wade")

        mView.rv_notification.adapter = context?.let { NotificationAdapter(it,notificationList) }
        mView.rv_notification.adapter?.notifyDataSetChanged()

        val notificationChList=ArrayList<String>()
        notificationChList.add("Challenge Won!")
        notificationChList.add("Challenge Won!")
        notificationChList.add("Challenge Lost")
        notificationChList.add("Challenge Lost")

        mView.rv_challenges_noti.adapter = context?.let { ChallengeNotificationAdapter(it,notificationChList) }
