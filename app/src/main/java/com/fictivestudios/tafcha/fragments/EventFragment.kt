...
class EventFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        mView.btn_create_new.setOnClickListener {
            getActivityContext
                ?.replaceFragment(
                    NewEventsFragment(),
                    NewEventsFragment.javaClass.simpleName,
                    true, true
                )
        }

        mView.layout_event.setOnClickListener {
    ...
    private fun initEventRecyclerview()
    {
        ...
        eventList.add("Justin Wade")
        eventList.add("Justin Wade")
        eventList.add("Justin Wade")

        mView.rv_event_history.adapter = context?.let { EventListAdapter(it,eventList) }
