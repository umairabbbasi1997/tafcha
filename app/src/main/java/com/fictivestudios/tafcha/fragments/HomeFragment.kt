...
class HomeFragment : BaseFragment() {
 ...
 //   var mViewPagerAdapter: ViewPagerAdapter? = null
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(com.fictivestudios.tafcha.R.layout.fragment_home, container, false)

        setViewPager()
     //   mView.viewPagerMain.adapter = UserMenuAdapter(parentFragmentManager)
      //  mView.tabDots.setupWithViewPager(viewPagerMain)
