...
import com.fictivestudios.tafcha.adapters.HistoryExpandedAdapter
 ...
 * Use the [PendingHistoryFragment.newInstance] factory method to
...
class PendingHistoryFragment : BaseFragment() {
    ...
    private fun initHistoryRecyclerview()
    {
        ...
        mView.rv_history_pending.adapter = context?.let { PendingHistoryAdapter(it,historyList) }
    ...
    companion object {
         ...
         * @return A new instance of fragment PendingHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PendingHistoryFragment().apply {
