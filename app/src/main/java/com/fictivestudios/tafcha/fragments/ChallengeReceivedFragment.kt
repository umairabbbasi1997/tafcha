 ...
 * Use the [ChallengeReceivedFragment.newInstance] factory method to
...
class ChallengeReceivedFragment : BaseFragment() {
    ...
    private fun initChallengeRecyclerview()
    {
        ...
        mView.rv_challenge_received.adapter = context?.let { ChallengeReceivedAdapter(it,challengeReqList) }
    ...
    companion object {
         ...
         * @return A new instance of fragment ChallengeReceivedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ChallengeReceivedFragment().apply {
