 ...
 * Use the [TrainerMyProfileFragment.newInstance] factory method to
...
class TrainerMyProfileFragment : BaseFragment() {
    ...
    private fun initclientRecyclerview()
    {
    ...
    companion object {
         ...
         * @return A new instance of fragment TrainerMyProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TrainerMyProfileFragment().apply {
