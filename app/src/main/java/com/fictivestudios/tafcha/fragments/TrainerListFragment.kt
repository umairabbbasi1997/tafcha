 ...
 * Use the [TrainerListFragment.newInstance] factory method to
...
class TrainerListFragment : BaseFragment() {
    ...
    private fun initTrainingRecyclerview()
    {
        ...
        val trainerList=ArrayList<String>()

        trainerList.add("John Smith")

        trainerList.add("Megan Gray")
        trainerList.add("Kevin Meyer")
        trainerList.add("Dennis Ellis")
        trainerList.add("Johnny Smith")
        trainerList.add("Natasha john")
        trainerList.add("Diana Gray")
        trainerList.add("John Smith")
        trainerList.add("John Smith")
        trainerList.add("John Smith")
