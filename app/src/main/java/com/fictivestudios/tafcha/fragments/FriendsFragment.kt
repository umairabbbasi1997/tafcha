...
class FriendsFragment : BaseFragment() {
    ...
    private fun initFriendsRecyclerview()
    {
        ...
        val addFriendList=ArrayList<String>()
        addFriendList.add("John Smith")
        addFriendList.add("John Smith")
        addFriendList.add("John Smith")

        mView.rv_invite_friend.adapter = context?.let { AddFriendsAdapter(it,friendList) }
