 ...
 * Use the [ResultHistoryFragment.newInstance] factory method to
...
class ResultHistoryFragment : Fragment() {
    ...
    private fun initHistoryRecyclerview()
    {
        ...
        mView.rv_history_result.adapter = context?.let { ResultHistoryAdapter(it,historyList) }
    ...
    companion object {
         ...
         * @return A new instance of fragment ResultHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ResultHistoryFragment().apply {
